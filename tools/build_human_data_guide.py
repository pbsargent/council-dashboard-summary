...
def build_doc():
    ...
    add_table(
        ...
        [
            ...
            ["Unit Key 3 Coverage", "Which units have current Unit Leader, Committee Chair, and COR/CUR coverage, which positions are missing, and how completion compares by unit type. Detail is organized in collapsible Service Area and District groups and shows SYT expiration beneath each holder, with expired or 90-day dates in red. Either a current COR or CUR satisfies the third position."],

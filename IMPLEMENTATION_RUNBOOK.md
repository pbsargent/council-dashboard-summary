...
- Unit Key 3 Detail remains grouped in a collapsible Service Area → District hierarchy. Expand/collapse controls retain the filtered population, and expanded district tables list missing units first while preserving direct Unit-Level Detail links.
